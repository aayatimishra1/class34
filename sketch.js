...
function setup() {
  ...
  world = engine.world;
   ...
   box1 = new Box(870, 100);
   box2 = new Box(870, 100);
   box3 = new Box(870, 100);
   box4 = new Box(870, 100);
   box5 = new Box(870, 100);
   box6 = new Box(870, 100);
   box7 = new Box(870, 100);
   box8 = new Box(870, 100);
